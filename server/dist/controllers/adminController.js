...
//get delivery partners list from admin
...
// asssing delivery partner of order
export const assignDeliveryPartner = async (req, res) => {
    ...
    if (order.status === "Placed" || order.status === "Confirmed") {
        status = "Assigned";
        history.push({ status: "Assigned", note: `Assigned to ${partner.name}`, timestamp: new Date(), partnerId });
    }

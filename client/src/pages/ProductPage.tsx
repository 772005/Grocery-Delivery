          ...
          <div className=" grid md:grid-cols-2 gap-0">
            ...
            <div className="relative flex-center p-8 md:p-12 min-h-[320px] md:min-h-[480px]">
              ...
              <div className="absolute top-5 left-5 flex flex-wrap gap-1.5">
                ...
                {product.discount && (
                  <span className="px-2.5 py-1 text-sm font-semibold bg-app-orange text-white rounded-full">
            ...
            <div className="p-6 md:p-10 flex flex-col justify-center">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center border border-app-border rounded-xl overflow-hidden">
                  ...
                  <button
                    onClick={() => {
                      ...
                      } else if (localQuantity < product.stock) {
                ...
                <button
                  ...
                  className={`flex-1 py-3 font-semibold rounded-xl transition-colors flex-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98] ${inCart ? "bg-app-cream text-app-green border border-app-green" : "bg-app-orange-dark text-white"}`}
                >
